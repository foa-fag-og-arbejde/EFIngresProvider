...
namespace EFIngresProvider.SqlGen.Functions
{
    ...
    /// </summary>
    public class StartsWithHandler : PatternHandlerBase
    {
        public override ISqlFragment HandleFunction(SqlGenerator sqlGenerator, DbFunctionExpression e)
        {
            ...
            {
                result = GetLikePredicate(sqlGenerator, e.Arguments[0], value, insertPercentStart: true, insertPercentEnd: false);
            }
            else
            {
